...
\section{ggF $H \rightarrow ZZ^* \rightarrow 4\mu$ performances}
In this section the fast simulation technique described in sec.\ref{subsec:PhysicsSimulation} is
applied to the study of the physics process $H \rightarrow ZZ^* \rightarrow 4\mu$. ITk performances are here compared for the three layouts described in sec.\ref{sec:tracking}, 
...
\caption{(a): $\eta$ spectrum of photons emitted from the muon lines of the process 
	ggF $H \rightarrow ZZ^* \rightarrow 4\mu$ with $p^\gamma_{T, max} = 1.5\ GeV$; 
	(b): Distribution of the $\Delta R$ distance between photons and muons in the events with $p^\gamma_{T, max} = 1.5\ GeV$.}
...
\subsubsection*{Signal process kinematics}
The kinematic After the generation selection, the 
