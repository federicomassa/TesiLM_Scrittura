...
\textbf{Total} & \color{dred} 0.548 & \color{dred} 0.332 & \color{dred} 0.565 & \color{dred} 0.345 & \color{dred} 0.566 & \color{dred} 0.344 \\ \hline 
\end{tabular}}
	\caption{Relative and total cut efficiencies for the three ITk layouts considered. The error on the total efficiency is not shown for graphical 
...
\textbf{Total} & \color{dred} 0.657 & \color{dred} 0.480 & \color{dred} 0.659 & \color{dred} 0.480 & \color{dred} 0.661 & \color{dred} 0.480 \\ \hline 
		\end{tabular}}
...
\textbf{Total} & \color{dred} 0.448 & \color{dred} 0.33 & \color{dred} 0.513 & \color{dred} 0.38 & \color{dred} 0.516 & \color{dred} 0.38 \\ \hline
		\end{tabular}}
	\caption{Relative and total cut efficiencies for the three ITk layouts considered, only for the
...
\textbf{Total} & \color{dred} 0.289  & \color{dred} 0.196  & \color{dred} 0.343  & \color{dred} 0.227  & \color{dred} 0.343  & \color{dred} 0.220 \\ \hline
	\end{tabular}}
	\caption{Relative and total cut efficiencies for the three ITk layouts considered, only for the
