...
\titolo{\textbf{Tracking performances of the ATLAS detector} \\
			\textbf{for the HL-LHC and impact on the} \\
			\textbf{$\mathbf{H\rightarrow ZZ^{*}\rightarrow 4\mu}$ channel}}
...
\markboth{\MakeUppercase{1. The Physics Scenario}}{\MakeUppercase{1. The Physics Scenario}}
...
\begin{table} [h]
	...
	\resizebox{.8\textwidth}{!}{
		...
		\hline
		$ \Delta\mu/\mu\ \ \ \ \ \   \ $ & \multicolumn{2}{c|}{300 fb$^{-1}$}  & \multicolumn{2}{c|}{3000 fb$^{-1}$} \\ 
...
\markboth{\MakeUppercase{2. ATLAS Detector}}{\MakeUppercase{2. ATLAS Detector}}
...
%accounts for $0.63\ X_0$ and, as cited in Chap.\ref{sec:magnet}, has been optimized. 
...
\markboth{\MakeUppercase{3. Physics objects reconstruction}}{\MakeUppercase{3. Physics objects reconstruction}}
...
\markboth{\MakeUppercase{4. Overview of the simulation technique}}{\MakeUppercase{4. Overview of the simulation technique}}
...
fragmentation of the proton or result in the production of a small number of final products and are called \textit{diffractive events}. The simulation of these
...
\centering
\includegraphics[width=.7\textwidth]{pileup_pt}
\caption{}
\label{fig:pileup_pt}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{pileup_eta}
\caption{}
\label{fig:pileup_eta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{pileup_phi}
\caption{}
...
\markboth{\MakeUppercase{5. Tracking performances of ITk}}{\MakeUppercase{5. Tracking performances of ITk}}
...
\begin{figure}
\centering
\includegraphics[width=.8\textwidth]{Tracking/nRecoTracks_eta_InclBrl4}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sigPt_abseta}
\caption{}
\label{fig:tracking:pi15pu200_sigPt_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sigQPt_abseta}
\caption{}
\label{fig:tracking:pi15pu200_sigQPt_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sigEta_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sigPhi_abseta}
\caption{}
\label{fig:tracking:pi15pu200_sigPhi_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sigD0_abseta}
\caption{}
\label{fig:tracking:pi15pu200_sigD0_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sigZ0_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sysPt_abseta}
\caption{}
\label{fig:tracking:pi15pu200_sysPt_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sysEta_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sysPhi_abseta}
\caption{}
\label{fig:tracking:pi15pu200_sysPhi_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sysD0_abseta}
\caption{}
\label{fig:tracking:pi15pu200_sysD0_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi15pu200_sysZ0_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pipu200_sigPt_abseta}
\caption{}
\label{fig:tracking:pipu200_sigPt_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pipu200_sigQPt_abseta}
\caption{}
\label{fig:tracking:pipu200_sigQPt_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pipu200_sigEta_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pipu200_sigPhi_abseta}
\caption{}
\label{fig:tracking:pipu200_sigPhi_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pipu200_sigD0_abseta}
\caption{}
\label{fig:tracking:pipu200_sigD0_abseta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pipu200_sigZ0_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/ExtBrl4/pi15_sigPt_abseta}
\caption{}
\label{fig:tracking:pi15_sigPt_abseta_ExtBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/ExtBrl4/pi15_sigQPt_abseta}
\caption{}
\label{fig:tracking:pi15_sigQPt_abseta_ExtBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/ExtBrl4/pi15_sigEta_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/ExtBrl4/pi15_sigPhi_abseta}
\caption{}
\label{fig:tracking:pi15_sigPhi_abseta_ExtBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/ExtBrl4/pi15_sigD0_abseta}
\caption{}
\label{fig:tracking:pi15_sigD0_abseta_ExtBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/ExtBrl4/pi15_sigZ0_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/IExtBrl4/pi15_sigPt_abseta}
\caption{}
\label{fig:tracking:pi15_sigPt_abseta_IExtBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/IExtBrl4/pi15_sigQPt_abseta}
\caption{}
\label{fig:tracking:pi15_sigQPt_abseta_IExtBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/IExtBrl4/pi15_sigEta_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/IExtBrl4/pi15_sigPhi_abseta}
\caption{}
\label{fig:tracking:pi15_sigPhi_abseta_IExtBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/IExtBrl4/pi15_sigD0_abseta}
\caption{}
\label{fig:tracking:pi15_sigD0_abseta_IExtBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/IExtBrl4/pi15_sigZ0_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pi15_sigPt_abseta}
\caption{}
\label{fig:tracking:pi15_sigPt_abseta_InclBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pi15_sigQPt_abseta}
\caption{}
\label{fig:tracking:pi15_sigQPt_abseta_InclBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pi15_sigEta_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pi15_sigPhi_abseta}
\caption{}
\label{fig:tracking:pi15_sigPhi_abseta_InclBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pi15_sigD0_abseta}
\caption{}
\label{fig:tracking:pi15_sigD0_abseta_InclBrl4}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/InclBrl4/pi15_sigZ0_abseta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi100pu200_sigQPt_abseta_zoom}
\caption{}
\label{fig:tracking:pi100pu200_sigQPt_abseta_zoom}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi100pu200_sigD0_abseta_zoom}
\caption{}
\label{fig:tracking:pi100pu200_sigD0_abseta_zoom}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{Tracking/Mixed/pi100pu200_sigZ0_abseta_zoom}
\caption{}
...
\multirow{3}{*}{100 GeV}  & 0 & 4.1 $\pm$ 0.1 \% & 3.42 $\pm$ 0.10 \% & 3.29 $\pm$ 0.09 \%\\ \cline{2-5}
 & 50 & 4.1 $\pm$ 0.1 \% & 3.2 $\pm$ 0.1 \% & 3.1 $\pm$ 0.1 \%\\ \cline{2-5}
...
\multirow{3}{*}{100 GeV}  & 0 & 94.5 $\pm$ 0.1 \% & 95.5 $\pm$ 0.1 \% & 95.7 $\pm$ 0.1 \%\\ \cline{2-5}
 & 50 & 94.6 $\pm$ 0.1 \% & 95.9 $\pm$ 0.1 \% & 96.0 $\pm$ 0.1 \%\\ \cline{2-5}
...
\markboth{\MakeUppercase{6. $H \rightarrow ZZ^* \rightarrow 4\mu$ performances}}{\MakeUppercase{6. $H \rightarrow ZZ^* \rightarrow 4\mu$ performances}}
...
\begin{figure}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/generatedMass}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{ZZ4mu/truthOnShellVsOffShell}
\caption{}
\label{fig:ZZ4mu:truthOnShellVsOffShell}
\end{subfigure}\\[1 ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{ZZ4mu/gen4muMass}
\caption{}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{HZZ4mu/HZZ4mu_photonPtLine}
  \caption{}
  \label{fig:HZZ4mu:photonPt}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{HZZ4mu/HZZ4mu_nPhotons}
  \caption{}
...
\begin{subfigure}{\linewidth}
  \centering
  \includegraphics[width=.7\textwidth]{HZZ4mu/HZZ4mu_photonEta}
  \caption{}
  \label{fig:HZZ4mu:photonEtaAfterCut}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
  \centering
  \includegraphics[width=.7\textwidth]{HZZ4mu/HZZ4mu_photonDR}
  \caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/muonPt}
\caption{}
\label{fig:HZZ4mu:pt}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/muonEta}
\caption{}
\label{fig:HZZ4mu:eta}
\end{subfigure}\\[1 ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/muonPhi}
\caption{}
...
\begin{figure}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/truthOutsideDetector}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigPt}
\caption{}
\label{fig:HZZ4mu:sigPt}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigQPt}
\caption{}
\label{fig:HZZ4mu:sigQPt}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigEta}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigPhi}
\caption{}
\label{fig:HZZ4mu:sigPhi}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigD0}
\caption{}
\label{fig:HZZ4mu:sigD0}
\end{subfigure}
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigZ0}
\caption{}
...
\begin{figure}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/nSiHits_matchedVsPileup}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/recoOnShellVsOffShell_new}
\caption{}
\label{fig:HZZ4mu:recoOnShellVsOffShell}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/recoMass_new}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigReco27}
\caption{}
\label{fig:HZZ4mu:sigReco27}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigReco32}
\caption{}
\label{fig:HZZ4mu:sigReco32}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigReco4}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/recoPt}
\caption{}
\label{fig:HZZ4mu:recoPt}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/recoEta}
\caption{}
\label{fig:HZZ4mu:recoEta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/recoPhi}
\caption{}
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigRecoPt}
\caption{}
\label{fig:HZZ4mu:sigRecoPt}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigRecoEta}
\caption{}
\label{fig:HZZ4mu:sigRecoEta}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{HZZ4mu/sigRecoPhi}
\caption{}
...
\begin{table} [h]
	...
	& \textbf{$\gamma$ selection}  & \textbf{No selection} & \textbf{$\gamma$ selection}  & \textbf{No selection} & \textbf{$\gamma$ selection}  & \textbf{No selection} \\ \hline
...
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{SB/SBInclBrl27}
\caption{}
\label{fig:SBInclBrl27}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{SB/SBInclBrl32}
\caption{}
\label{fig:SBInclBrl32}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=.7\textwidth]{SB/SBInclBrl4}
\caption{}
...
\markboth{\MakeUppercase{A. ATLAS reference frame and track parameters}}{\MakeUppercase{A. ATLAS reference frame and track parameters}}
