...
high resolution pattern recognition using \textit{silicon pixel layers}, the middle one consists of stereo pairs of \textit{silicon microstrip} (SCT) layers and the outermost one consists of a \textit{transition radiation tracker} (TRT). 

\subsubsection*{Pixel and SCT sensors}

\subsubsection*{TRT tubes}
